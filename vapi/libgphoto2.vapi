...
namespace GPhoto {
    ...
    [CCode (
        cname="CameraWidgetType",
        cheader_filename="gphoto2/gphoto2-widget.h",
        cprefix="GP_WIDGET_"
    )]
    [Flags]
    ...
    [CCode (
        cname="CameraWidget",
        ref_function="GPHOTO_REF_WIDGET",
        unref_function="gp_widget_unref",
        free_function="gp_widget_free",
        cheader_filename="gphoto2/gphoto2-widget.h,gphoto.h"
    )]
    public class CameraWidget {
        [CCode (cname="gp_widget_new")]
        public static Result create (CameraWidgetType type, string label, out CameraWidget widget);

        [CCode (cname="gp_widget_append")]
        public Result append (CameraWidget child);
        [CCode (cname="gp_widget_prepend")]
        public Result prepend (CameraWidget child);
        [CCode (cname="gp_widget_count_children")]
        ...
        public Result get_value (out void *value);
        [CCode (cname="gp_widget_set_name")]
        public Result set_name (string name);
        [CCode (cname="gp_widget_get_name")]
        public Result get_name (out unowned string name);
        [CCode (cname="gp_widget_set_info")]
        public Result set_info (string info);
        [CCode (cname="gp_widget_get_info")]
        public Result get_info (out unowned string info);
        [CCode (cname="gp_widget_get_id")]
        public Result get_id (out int id);
        [CCode (cname="gp_widget_get_type")]
        public Result get_type (out CameraWidgetType type);
        [CCode (cname="gp_widget_get_label")]
        public Result get_label (out unowned string label);
        [CCode (cname="gp_widget_set_range")]
        public Result set_range (float  low, float  high, float  increment);
        [CCode (cname="gp_widget_get_range")]
        public Result get_range (out float min, out float max, out float increment);
        [CCode (cname="gp_widget_add_choice")]
        public Result add_choice (string choice);
        [CCode (cname="gp_widget_count_choices")]
        public int count_choices ();
        [CCode (cname="gp_widget_get_choice")]
        public Result get_choice (int choice_number, out unowned string choice);
        [CCode (cname="gp_widget_changed")]
        public Result changed ();
        [CCode (cname="gp_widget_set_changed")]
        public Result set_changed (int changed);
    ...
    public struct CameraText {
        ...
        /**
         * Get the text field as a string.
         *
         * XXX This was added before testing a string cast on the char array
         *     which seems to work fine. Possibly remove this.
         *
         * @return text field as a string
         */
    ...
    public struct CameraFilePath {
        ...
        /**
         * Get the name field as a string.
         *
         * XXX This was added before testing a string cast on the char array
         *     which seems to work fine. Possibly remove this.
         *
        ...
        /**
         * Get the folder field as a string.
         *
         * XXX This was added before testing a string cast on the char array
         *     which seems to work fine. Possibly remove this.
         *
         * @return folder field as a string
         */
    ...
    public class Camera {
        ...
        public Result get_summary (out CameraText summary, Context context);
        public Result get_manual (out CameraText manual, Context context);
        public Result get_about (out CameraText about, Context context);
    ...
    public class Context {
        ...
        public void set_progress_funcs (
            [CCode (delegate_target_pos=3.1)]
            ContextProgressStartFunc startFunc,
            [CCode (delegate_target_pos=3.1)]
            ContextProgressUpdateFunc updateFunc,
            [CCode (delegate_target_pos=3.1)]
            ContextProgressStopFunc stopFunc);
